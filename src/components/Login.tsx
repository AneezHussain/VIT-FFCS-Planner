  ...
  return (
    <div className="login-container flex items-center justify-center min-h-screen bg-gray-100">
      <div className="login-box bg-white shadow-xl rounded-lg flex overflow-hidden max-w-4xl w-full">
        ...
        <div className="login-image hidden md:flex md:w-1/2 items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 p-8">
          {/* You can use a relevant illustration for FFCS Planner */}
          <img src="/login-illustration.svg" alt="FFCS Planner Illustration" className="max-w-xs"/> 
        </div>
      </div>
    </div>
  );
